...
import 'package:sandwitch/views/nonadmin/snackslist.dart';

import '../../controller/non_admin_controller.dart';

class NonAdminDrinkListItem extends StatelessWidget {
  NonAdminDrinkListItem(this.productList);
    ...
    return Container(
      ...
      child: Row(
        children: [
          GestureDetector(
            onTap: () {
              nonAdminController.drinkId.value = productList.id.toString();
              Get.to(SnackList());
            },
            child: Container(
                height: 100,
